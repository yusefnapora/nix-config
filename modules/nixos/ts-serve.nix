# taken from https://github.com/yomaq/nix-config/blob/87a74a0b37853f0c648a57805d4e7843e3dc0923/modules/containers/tailscale-submodule.nix
# Thanks!
    ...
    in
    {
      options = {
        ...
        volumeLocation = lib.mkOption {
          type = lib.types.str;
          default = "/container-data/tailscale/${name}";
          description = ''
